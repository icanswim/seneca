...
class TfPipe:
	...
	def train(self, X_train, y_train, X_test, y_test):
		#TODO logic for classification vs regression
		if classes:
		...
		with self.sess.as_default():
			...
			accuracy, accuracy_update = tf.metrics.accuracy(dataset['label'], 
												dataset['prediction'], 
												name='accuracy')
																		
			train_step, loss = self._loss_func(y, self.model.output, loss_func)
